...
export const DetailPage = () => {
  ...
  useEffect(() => {
    if (player)
      fetch('https://restcountries.com/v3.1/alpha/' + player.country.code)
        ...
        .then((cdatas) =>
          cdatas.map((cdata: any) => setCname(cdata.name.common))
        )
  }, [])
  ...
  if (player) {
    ...
    return (
      ...
      >
        <Button
          sx={{ display: 'block', zIndex: 10, marginTop: '1rem' }}
    ...
    return <p> You have refreshed the page! Please go back to homepage. </p>
}
